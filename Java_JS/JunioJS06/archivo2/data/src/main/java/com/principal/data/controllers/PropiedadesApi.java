...
public class PropiedadesApi {
    ...
    @PostMapping("")
    public Propiedades createPropiedad(@RequestParam("registro") String registro, @RequestParam("categoria") String categoria, @RequestParam("direccion") String direccion,@RequestParam("area") String area,@RequestParam("user_id") Long user_id){
        ...
        Propiedades propiedad = new Propiedades(null,registro, categoria, direccion, Double.parseDouble(area),foundUser, null, null);

        return propiedadesService.createPropiedad(propiedad);
    }

    @PutMapping("/{id}")
    public Propiedades updatePropiedad(@PathVariable("id") Long id,@RequestParam("registro") String registro, @RequestParam("categoria") String categoria, @RequestParam("direccion") String direccion,@RequestParam("area") String area){
     
        Propiedades propiedad = new Propiedades(id,registro, categoria, direccion, Double.parseDouble(area), null, null, null);
