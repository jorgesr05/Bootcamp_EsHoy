...
public class Postre extends Comida {
    ...
    public Postre(String base, boolean harina, boolean frutal, boolean nueces, String toppings) {
        this.base = base;
        this.harina = harina;
        this.frutal = frutal;
        this.nueces = nueces;
    ...
    public Postre(boolean vegetariano,  boolean fresco, String nombre, boolean cocinable,
            ...
            String toppings) {
        super(vegetariano, salado, fresco, nombre, cocinable, picante, "Postre",origen);
        this.base = base;
        this.harina = harina;
        this.frutal = frutal;
        this.nueces = nueces;
